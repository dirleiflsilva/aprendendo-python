# Tela de login usando TKinter, para validar usuário e senha
from tkinter import *

class Principal:  # cria a classe principal
    # cria o metodo inicial e que sera filho da classe Principal
    def __init__(self, master=None):
        ...
        # para exibir os widgets do container
        ...
        # cria um container para label e text field senha
    ...
    def verificaSenha(self):
        # apanha os dados digitados pelo usuário no text field 'nome'
...
# instancia a classe Tk() atraves da variavel tela
tela = Tk()
tela.title("TELA DE LOGIN")
tela["bg"] = "light green"
# define o tamanho da tela em width (largura) x height (altura)
tela.geometry("400x250")
# instancia da classe Principal, passamos a variavel tela como parametro
Principal(tela)
# metodo obrigatorio para carregar a tela e para que os eventos ocorram
tela.mainloop()